...
export default function DualQuatSkinMaterial( val='cyan', skin ){
    const uniforms = {
...
mat2x4 getBoneDualQuat( vec4[90] poseq, vec4[90] posep, vec4 idx, vec4 wgt ){
    //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
void main() {
    mat2x4 boneDQ   = getBoneDualQuat( poseq, posep, skinIndex, skinWeight );  // Compute the Bone's Dual Quaternion
